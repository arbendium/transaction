...
export default function resolveCachedKeyRangeSelectors(start, end, reverse, limit, index) {
	...
	if (typeof startKeySelector === 'number' && ) {
		if (typeof endKeySelector === 'number') {
			return fixedStartAndEndEntry(startKeySelector, endKeySelector, reverse, limit, index);
		} else {
			return fixedStartEntry(startKeySelector, endKeySelector, reverse, limit, index);
		}
	}
